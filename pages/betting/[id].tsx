                    ...
                    {allGamesList.map((gameItem, index) => {
                      ...
                      return (
                        ...
                        <div className="text-center">
                          ...
                          {gameItem.bets && gameItem.bets.length > 0 && (
                            <div className="mt-1.5 sm:mt-2 p-0.5 sm:p-1 md:p-1.5 rounded bg-blue-100 dark:bg-accent-dark-900/30">
                              <div className="text-[10px] sm:text-xs font-semibold text-blue-700 dark:text-accent-dark-400">
